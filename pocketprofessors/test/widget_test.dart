...
expect(find.widgetWithText(TextField, 'First Name (for Register)'), findsOneWidget);
expect(find.widgetWithText(TextField, 'Last Name (for Register)'), findsOneWidget);
...
expect(find.byType(Text), findsWidgets); // Generic check — optional refinement
});
}